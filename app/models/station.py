...
class Station(Base):
    ...
    status = Column(String(20), nullable=False)  # available, occupied, maintenance, unknown
    ...
    __table_args__ = (
        Index('idx_station_location', 'latitude', 'longitude'),  # Index for location-based queries
        Index('idx_station_connector', 'connector_type'),  # Index for connector type filtering
